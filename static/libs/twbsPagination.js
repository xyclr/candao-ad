...
//(function ($, window, document, undefined) {
    ...
    TwbsPagination.prototype = {
        ...
        buildListItems: function (pages) {
            ...
            if (this.options.first && (pages.currentPage - 3) >1 ) {
            ...
            if (this.options.last && (this.options.totalPages > (pages.currentPage + 3))) {
        ...
        render: function (pages) {
            var base = this;
            var $parent = this.$listContainer.parent();
            this.$listContainer.children().remove();
            this.$listContainer.append(this.buildListItems(pages));


            if($('.page-btn-box').length == 0 && base.options.has_btn_box) {
                var $pageBtnBox = '<div class="page-btn-box"><input type="text" class="J-page-ipt page-ipt"  value="" /><a href="javascript:void(0)" class="page-btn">跳转</a></div>';
                $parent.append($pageBtnBox);
                $parent.on('click','.page-btn',function(e){
                    base.show(parseInt($parent.find('.J-page-ipt').val()));
                    e.preventDefault();
                });
                $parent.on('keyup','.J-page-ipt',function(){
    ...
    var twbsPagination = $.fn.twbsPagination = function (option) {
